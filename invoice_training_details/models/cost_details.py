...
class CostDetails(models.Model):
    ...
    def _compute_margin(self):
        for rec in self:
            total_price = rec.cos_lead_id.total_training_price or 1  
            rec.margin = ((rec.nilme_share or 0) / total_price) * 100  
    ...
    def _register_hook(self):
        """Safely modifies the tree view without breaking the database connection."""
