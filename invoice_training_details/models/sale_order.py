...
class SaleOrder(models.Model):
    ...
    term_and_cond = fields.Html(string='Term and conditions',default='Details:
...
Please email your invoice per the above T&Cs
Payment Terms:  Net60 after delivery Please notify us immediately if you are unable to deliver as specified.
Send all correspondence to:
yabosaleh@nil-me.com
NIL ME – DMCC – JLT 
Dubai - UAE
)
